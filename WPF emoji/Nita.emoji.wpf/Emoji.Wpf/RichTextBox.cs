...
namespace Emoji.Wpf
{
    ...
    public class RichTextBox : Controls.RichTextBox, IEmojiControl
    {
        ...
        static RichTextBox()
        {
            FontFamilyProperty.OverrideMetadata(
              ...
              new FrameworkPropertyMetadata(
                  (FontFamily)FontFamilyProperty.GetMetadata(typeof(Controls.RichTextBox)).DefaultValue,
                  (o, e) => (o as RichTextBox)?.OnFontFamilyChanged((FontFamily)e.NewValue)));
        }
        ...
        {
            EmojiData.ChangeFont(fontfamliy.Source);
            EmojiInline.Refresh();
