...
/*
            // 判断属性是否为 FontFamily 属性
            if (e.Property.PropertyType == typeof(FontFamily))
            {
               OnFontFamilyChanged((FontFamily)e.NewValue);
            }*/
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (m_rtb == null) return; // 如果没有找到元素，就返回
